...
Using `{prqlr}` with `{knitr}` makes it easy to create documents that convert PRQL to SQL,
or actually manipulate the database with PRQL to get results (requires the `{DBI}` package and DBI backends).
